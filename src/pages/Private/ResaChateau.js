...
import backGround from '../../assets/bg-chateau.jpg'
...
export default function ResaChateau() {
  ...
  function validateNumber() {
    if(number === '') {
        alert('Indiquez le nombre de personnes s\'il vous plaît')
        return false
    } else {
        return true
    }
        ...
        <LoisirsNavBar />
          ...
          <Container maxWidth="50%" sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
              <Typography variant='h2' sx={{ textAlign: 'center', marginTop: '50px' }}>
                  RÉSERVATION EXCURSION AU CHÂTEAU DU TAUREAU
              </Typography>
              ...
              <FormControl sx={{ minWidth: 400, marginTop: '25px' }}>
                  <InputLabel id='select-personnes-label'>Nombre de personnes</InputLabel>
                  <Select
                      labelId="select-personnes-label"
                      id="select-personnes"
                      open={open2}
