...
import backGround from '../../assets/bg-kayak.jpg'
...
export default function ResaKayak() {
      ...
      <Container maxWidth="50%" sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '25px', marginTop: '25px' }}>
          <FormControl sx={{ minWidth: 275 }}>
            <InputLabel id='select-kayak-label'>Type de kayak</InputLabel>
            <Select
              ...
              label="Type de kayak"
            >
              <MenuItem value='Kayak1pOuvert'>Kayak 1 place ouvert</MenuItem>
              <MenuItem value='Kayak2pOuvert'>Kayak 2 places ouvert</MenuItem>
              <MenuItem value='Kayak4pOuvert'>Kayak 4 places ouvert</MenuItem>
              <MenuItem value='Kayak1pFerme'>Kayak 1 place fermé</MenuItem>
            </Select>
          </FormControl>
