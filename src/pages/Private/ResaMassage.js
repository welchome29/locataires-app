...
import backGround from '../../assets/bg-bienetre-massage.jpg'
...
export default function ResaMassage() {
      ...
      <Container maxWidth="50%" sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '25px', marginTop: '25px' }}>
          <FormControl sx={{ minWidth: 400 }}>
            <InputLabel id='select-duree-label'>Durée du soin</InputLabel>
            <Select
              labelId="select-duree-label"
              id="select-duree"
              open={open}
              onClose={handleClose}
              onOpen={handleOpen}
              ...
              label="Durée du soin"
            >
              <MenuItem value='20min'>Massage Zen 20mn : 65€</MenuItem>
              <MenuItem value='30min'>Massage Zen 30mn : 80€</MenuItem>
            </Select>
          </FormControl>
        </div>
        <div style={{ display: 'flex', gap: '25px', marginTop: '25px' }}>
