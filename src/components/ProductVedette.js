...
export default function ProductVedette() {
    ...
    const handleOpenAperoCat = () => navigate('/private/apéro') 
    ...
    return (
        <Container maxWidth="100%" sx={{ display: 'flex', justifyContent: 'center',  gap: '100px', flexWrap: 'wrap'}}>
            <Card sx={{ maxWidth: 400, minWidth: 400, border: '1px solid lightgray' }}>
                <CardHeader
                    avatar={
                        <Tooltip title="Accéder à la catégorie Apéro">
            ...
            <Card sx={{ maxWidth: 400, minWidth: 400, border: '1px solid lightgray' }}>
                <CardHeader
                    avatar={
                        <Tooltip title="Accéder à la catégorie Fruits de Mer" onClick={handleOpenFdmCat}>
