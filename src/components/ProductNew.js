...
export default function ProductNew() {
    ...
    useEffect(() => {
        const docRef1 = doc(db, 'Products', 'Tpnr5eTXxfGACYt4RRBD')
    ...
    useEffect(() => {
        const docRef2 = doc(db, 'Products', 'KLyUvNFyxEuTjihjQ7MV')
    ...
    useEffect(() => {
        const docRef3 = doc(db, 'Products', 'WKwzw07kWa4qWUHQ2y66')
    ...
    const handleOpenFruitsLegCat = () => navigate('/private/fruits et légumes') 
    const handleOpenPlatsCat = () => navigate('/private/plats cuisinés')
    const handleOpenSpiritueuxCat = () => navigate('/private/spiritueux')
    ...
    return (
        <Container maxWidth="100%" sx={{ display: 'flex', justifyContent: 'center',  gap: '100px', flexWrap: 'wrap'}}>
            <Card sx={{ maxWidth: 400, minWidth: 400, border: '1px solid lightgray' }}>
                <CardHeader
                    avatar={
                        <Tooltip title="Accéder à la catégorie Fruits et Légumes">
                            <Avatar sx={{ bgcolor: green[500], cursor: 'pointer' }} aria-label="recipe" onClick={handleOpenFruitsLegCat}>
                                <GrassIcon />
                            </Avatar>
                        </Tooltip>
                    }
                ...
                <CardHeader
                    avatar={
                        <Tooltip title="Accéder à la catégorie Spiritueux">
                            <Avatar sx={{ bgcolor: orange[500], cursor: 'pointer' }} aria-label="recipe" onClick={handleOpenSpiritueuxCat}>
                                <LiquorIcon />
                            </Avatar>
                        </Tooltip>
                    }
